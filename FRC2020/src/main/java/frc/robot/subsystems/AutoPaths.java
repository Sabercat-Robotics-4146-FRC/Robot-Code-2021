 ...
 * AutoPaths
 * 
 * All methods need to be static
 * 
 * stores the paths and calculations needed to run autos
 */
public class AutoPaths {
    ...
    private static final double[][] doNothingPath = new double[][] {
        {0,0},
        {0,0}
    };
    ...
    private static final double[][] rightSide3x3Path = new double[][] {
        {0,0},
        {0,3},
        {2,5}
    };
