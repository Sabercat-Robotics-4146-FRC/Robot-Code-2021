...
public class Limelight extends Subsystem {
  ...
  public static final int kSortTopPipeline = 1;
  ...
  public synchronized void readPeriodicInputs() {
    mPeriodicIO.latency =
        mNetworkTable.getEntry("tl").getDouble(0) / 1000.0 + Constants.kImageCaptureLatency;
  ...
  private static final Comparator<Translation2d> xSort =
      Comparator.comparingDouble(Translation2d::x);
  private static final Comparator<Translation2d> ySort =
   ...
   * @return list of corners: index 0 - top left, index 1 - top right
   */
  public static List<double[]> extractTopCornersFromBoundingBoxes(
    ...
    return List.of(
        new double[] {leftCorner.x(), leftCorner.y()},
