...
public class Autonomous {
    ...
    private Autonomous() {
        ...
        combinedDigitalInput = (input1.get() ? 1 : 0) + (input2.get() ? 1 : 0) * 2 + (input3.get() ? 1 : 0) * 4;
    ...
    public void getAutoPath(int autoStep) {
        ...
        case 0: // Do Nothing
            ...
            rightVelocities = PathPlanner.doubleArrayCopy(AutoPaths.getDoNothing().mSmoothRightVelocity);
        ...
        case 1: // Right Side 3x3
            ...
            if (autoStep == 1) {
                ...
                leftVelocities = PathPlanner.doubleArrayCopy(AutoPaths.getRightSide3x3Auto().mSmoothLeftVelocity);
                rightVelocities = PathPlanner.doubleArrayCopy(AutoPaths.getRightSide3x3Auto().mSmoothRightVelocity);
