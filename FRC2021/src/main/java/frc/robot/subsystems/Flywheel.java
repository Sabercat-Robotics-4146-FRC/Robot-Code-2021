...
public class Flywheel extends Subsystem {
  ...
  private Flywheel() {
    ...
    // set gains
    TalonSRXUtil.checkError(
        mMaster.config_kP(0, Constants.kFlywheelKp, Constants.kLongCANTimeoutMs),
        "Flywheel: could not set kP: ");
    TalonSRXUtil.checkError(
        mMaster.config_kI(0, Constants.kFlywheelKi, Constants.kLongCANTimeoutMs),
        "Flywheel: could not set kI: ");
    TalonSRXUtil.checkError(
        mMaster.config_kD(0, Constants.kFlywheelKd, Constants.kLongCANTimeoutMs),
        "Flywheel: could not set kD: ");
    TalonSRXUtil.checkError(
        mMaster.config_kF(0, Constants.kFlywheelKf, Constants.kLongCANTimeoutMs),
        "Flywheel: Could not set kF: ");

    mSlave =
        TalonSRXFactory.createPermanentSlaveTalon(
            Constants.kFlywheelSlaveId, Constants.kFlywheelMasterId);
  }
